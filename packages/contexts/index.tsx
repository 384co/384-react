...
export interface AppConfig extends WalletConfig, SBServer {
    salt?: Uint8Array,
    iterations?: number,
}

interface React384ContextType extends React.PropsWithChildren<{}> {
    config: AppConfig
}

export function React384({ children, config }: React384ContextType) {
    const SBConfig = {
    ...
    const WalletConfig: WalletConfig = {
        ...
        wallet_from_384_os: config.wallet_from_384_os,
