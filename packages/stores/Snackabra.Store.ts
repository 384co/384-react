...
export interface SnackabraStoreType {
  ...
  createContact: (contsct: Contact, keyOrPubIdentifier: KeyOrPubIdentifier) => Contact;
  getContact: (keyOrPubIdentifier: KeyOrPubIdentifier) => Contact;
  hasChannel: (channelId: string) => boolean;
  getChannel: (channelId: string) => ChannelStoreType;
}

type KeyOrPubIdentifier = PubIdentifier | JsonWebKey

type PubIdentifier = `${JsonWebKey['x']} ${JsonWebKey['y']}`

type Channels = { [key: string]: (SerializedChannel | ChannelStore) }
...
type Contacts = { [key: `${JsonWebKey['x']} ${JsonWebKey['y']}`]: Contact }
